...
#define __CONFIG_H__
#define UNIX
#define GPHELP "/usr/64/local/bin/gphelp"
#define GPDATADIR "/usr/64/local/share/pari"
#define SHELL_Q '\''

#define PARIVERSION "GP/PARI CALCULATOR Version 2.5.0 (released)"
#define PARIINFO "i386 running darwin (x86-64 kernel) 64-bit version"
#define PARI_VERSION_CODE 132352
#define PARI_VERSION(a,b,c) (((a) << 16) + ((b) << 8) + (c))
#define PARI_VERSION_SHIFT 8
#define PARI_VCSVERSION ""

#define PARI_DOUBLE_FORMAT -
#define GCC_VERSION "4.2.1 (Apple Inc. build 5666) (dot 3)"
#define ASMINLINE

...
#define at_barplot at_diagramme_batons
...
#define at_is_cospherical at_est_cospherique
...
#define at_is_isosceles at_est_isocele
...
#define at_isosceles_triangle at_triangle_isocele

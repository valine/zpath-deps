...
{"%#",0,(void*)pari_histtime,18,"D0,L,","time to compute last history item."},
...
{"_'_",0,(void*)derivn,18,"GLDn","x': derivative of x with respect to the main variable."},
...
{"_FpM_ratlift_worker",0,(void*)FpM_ratlift_worker,20,"GGG","worker for FpM_ratlift"},
{"_Fp_log_sieve_worker",0,(void*)Fp_log_sieve_worker,20,"LLGGGGGG","Fp_log_sieve_worker: worker for Fp_log_sieve"},
{"_QM_charpoly_ZX_worker",0,(void*)QM_charpoly_ZX_worker,20,"GGG","worker for QM_charpoly_ZX"},
{"_QXQ_div_worker",0,(void*)QXQ_div_worker,20,"GGGG","worker for QXQ_div"},
{"_QXQ_inv_worker",0,(void*)QXQ_inv_worker,20,"GGG","worker for QXQ_inv"},
{"_ZM_det_worker",0,(void*)ZM_det_worker,20,"GG","worker for ZM_det"},
{"_ZM_inv_worker",0,(void*)ZM_inv_worker,20,"GG","worker for ZM_inv"},
{"_ZM_ker_worker",0,(void*)ZM_ker_worker,20,"GG","worker for ZM_ker"},
{"_ZM_mul_worker",0,(void*)ZM_mul_worker,20,"GGG","worker for ZM_mul"},
{"_ZXQX_direct_compositum_worker",0,(void*)ZXQX_direct_compositum_worker,20,"GGGG","worker for ZX_direct_compositum"},
{"_ZXQX_resultant_worker",0,(void*)ZXQX_resultant_worker,20,"GGGGG","worker for ZXQX_resultant"},
{"_ZXQ_minpoly_worker",0,(void*)ZXQ_minpoly_worker,20,"GGGL","worker for ZXQ_minpoly"},
{"_ZX_ZXY_resultant_worker",0,(void*)ZX_ZXY_resultant_worker,20,"GGGGG","worker for ZX_ZXY_resultant"},
{"_ZX_direct_compositum_worker",0,(void*)ZX_direct_compositum_worker,20,"GGG","worker for ZX_direct_compositum"},
{"_ZX_gcd_worker",0,(void*)ZX_gcd_worker,20,"GGGG","worker for ZX_gcd"},
...
{"_chinese_unit_worker",0,(void*)chinese_unit_worker,20,"GGGGGG","worker for _.fu"},
{"_derivfun",0,(void*)derivfun0,20,"GGGD1,L,p","_derivfun(args,def,closure,k) numerical kth-derivation of closure with respect to the first variable at args"},
{"_dirartin_worker",0,(void*)dirartin_worker,20,"GUGGGG","lfunartin worker"},
{"_direllnf_worker",0,(void*)direllnf_worker,20,"GUG","ellan worker"},
{"_direllsympow_worker",0,(void*)direllsympow_worker,20,"GUGU","lfunsympow worker"},
{"_dirgenus2_worker",0,(void*)dirgenus2_worker,20,"GLG","lfungenus2 worker"},
{"_ecpp_ispsp_worker",0,(void*)ecpp_ispsp_worker,20,"G","worker for isprime (ECPP ispseudoprime step)"},
{"_ecpp_sqrt_worker",0,(void*)ecpp_sqrt_worker,20,"GGG","worker for isprime (ECPP sqrt step)"},
{"_ecpp_step2_worker",0,(void*)ecpp_step2_worker,20,"GGG","worker for isprime (step 2)"},
{"_eisker_worker",0,(void*)eisker_worker,20,"GGGGG","worker for eisker"},
{"_ellQ_factorback_worker",0,(void*)ellQ_factorback_worker,20,"GGGG","ellmul(E,z,n): n times the point z on elliptic curve E (n in Z)."},
...
{"_lfuninit_theta2_worker",0,(void*)lfuninit_theta2_worker,20,"LGGGGGG","worker for lfuninit using theta2"},
{"_lfuninit_worker",0,(void*)lfuninit_worker,20,"LGGGGGGGG","worker for lfuninit"},
...
{"_parapply_slice_worker",0,(void*)parapply_slice_worker,20,"GG","_parapply_slice_worker(v,C): return [C(x) | x<-v]."},
...
{"_polmodular_worker",0,(void*)polmodular_worker,20,"GUGGGGLGG","used by polmodular"},
{"_primecertisvalid_ecpp_worker",0,(void*)primecertisvalid_ecpp_worker,20,"G","worker for primecertisvalid"},
{"_ramanujantau_worker",0,(void*)ramanujantau_worker,20,"GGGG","worker for ramanujantau"},
{"_safecoeff",0,NULL,18,NULL,"safe version of x[a], x[,a] and x[a,b]. Must be lvalues."},
{"_taugen_n_worker",0,(void*)taugen_n_worker,20,"GGG","worker for ramanujantau"},
...
{"bernpol",0,(void*)bernpol,4,"LDn","bernpol(n, {v = 'x}): Bernoulli polynomial B_n, in variable v."},
...
{"besseljzero",0,(void*)besseljzero,8,"GD1,L,b","besseljzero(nu,{k=1}): k-th zero of the J-bessel function of index nu."},
...
{"besselyzero",0,(void*)besselyzero,8,"GD1,L,b","besselyzero(nu,{k=1}): k-th zero of the Y-bessel function of index nu."},
...
{"binomial",0,(void*)binomial0,4,"GDG","binomial(x,{k}): binomial coefficient x*(x-1)...*(x-k+1)/k! defined for k in Z and any x. If k is omitted and x an integer, return the vector [binomial(x,0),...,binomial(x,x)]."},
...
{"dirpowerssum",0,(void*)dirpowerssum0,5,"GGDGp","dirpowerssum(N,x,{f}): return f(1)1^x + f(2)2^x + ... + f(N)N^x, where f is a completely multiplicative function (= 1 if omitted)"},
...
{"ellanalyticrank",0,(void*)ellanalyticrank_bitprec,12,"GDGb","ellanalyticrank(E, {eps}): returns the order of vanishing at s=1 of the L-function of the elliptic curve E and the value of the first nonzero derivative. To determine this order, it is assumed that any value less than eps is zero. If no value of eps is given, 2^(-bitprecision/2) is used."},
...
{"ellgroup",0,(void*)ellgroup0,12,"GDGD0,L,","ellgroup(E,{p},{flag}): given an elliptic curve E defined over a finite field Fq, return the structure of the group E(Fq); for other fields of definition K, p must define a finite residue field (p prime for K = Qp or Q; p a maximal ideal for K a number field) and we return the structure of the (nonsingular) reduction of E. If flag is 1, return also generators, the curve equation must be minimal at p."},
...
{"getcache",0,(void*)getcache,14,"","getcache(): returns information about various auto-growing caches. For each resource, we report its name, its size, the number of cache misses (since the last extension) and the largest cache miss."},
...
{"hypergeom",0,(void*)hypergeom,8,"DGDGGp","hypergeom({N},{D},z): general hypergeometric function, where N and D are the vector of parameters in the numerator and denominator respectively, evaluated at the complex argument z."},
...
{"lfunmfspec",0,(void*)lfunmfspec,13,"Gb","lfunmfspec(L): L corresponding to a modular eigenform, returns [ve,vo,om,op] in even weight, where ve (resp., vo) is the vector of even (resp., odd) periods, and om and op the corresponding real numbers omega^- and omega^+. Returns [v,om] in odd weight."},
...
{"lfunparams",0,(void*)lfunparams,13,"Gp","lfunparams(ldata): return the parameters [N, k, vga] of the L-function  defined by ldata (see lfuncreate).  The parameters Vga (gamma shifts) are returned to the current precision."},
...
{"mfEH",0,(void*)mfEH,14,"G","mfEH(k): k>0 being in 1/2+Z, mf corresponding to the Cohen-Eisenstein series H_k of weight k on G_0(4)."},
{"mfEk",0,(void*)mfEk,14,"L","mfEk(k): mf corresponding to the standard Eisenstein series E_k for nonnegative even integer k."},
...
{"mfcoef",0,(void*)mfcoef,14,"GL","mfcoef(F,n): Compute the n-th Fourier coefficient a(n) of the generalized modular form F."},
{"mfcoefs",0,(void*)mfcoefs,14,"GLD1,L,","mfcoefs(F,n,{d = 1}): Compute the vector of coefficients [a[0],a[d],...,a[nd]] of the modular form F."},
{"mfconductor",0,(void*)mfconductor,14,"lGG","mfconductor(mf,F): mf being output by mfinit and F a modular form, gives the smallest level at which F is defined."},
{"mfcosets",0,(void*)mfcosets,14,"G","mfcosets(N): list of right cosets of G_0(N)\\G, i.e., matrices g_j in G such that G = U G_0(N) g_j. The g_j are chosen in the form [a,b; c,d] with c | N."},
...
{"mfcusps",0,(void*)mfcusps,14,"G","mfcusps(N): list of cusps of G_0(N) in the form a/b with b dividing N."},
{"mfcuspval",0,(void*)mfcuspval,14,"GGGb","mfcuspval(mf,F,cusp): valuation of modular form F in the space mf at cusp, which can be either oo or any rational number. The result is either a rational number or oo if F is zero. Let chi be the Nebentypus of the space mf; if Q(F) != Q(chi), return the vector of valuations attached to the [Q(F):Q(chi)] complex embeddings of F."},
{"mfcuspwidth",0,(void*)mfcuspwidth,14,"lGG","mfcuspwidth(N, cusp): width of cusp in Gamma_0(N)."},
...
{"mfdescribe",0,(void*)mfdescribe,14,"GD&","mfdescribe(F,{&G}): gives a human-readable description of F, which is either a modular form space or a modular form. If the address of G is given, puts into G the vector of parameters of the outmost operator defining F."},
...
{"mfgaloisprojrep",0,(void*)mfgaloisprojrep,14,"GGp","mfgaloisprojrep(mf,F): mf being an mf output by mfinit in weight 1, and F an eigenform, returns a polynomial defining the field fixed by the kernel of the projective representation associated to F."},
...
{"mfisetaquo",0,(void*)mfisetaquo,14,"GD0,L,","mfisetaquo(f,{flag=0}): if the generalized modular form f is a holomorphic eta quotient, return the eta quotient matrix, else return 0. If flag is set, also accept meromorphic eta quotients."},
...
{"mfshimura",0,(void*)mfshimura,14,"GGD1,L,","mfshimura(mf, F, {D = 1}): F being a modular form of half-integral weight k >= 3/2 and t a positive squarefree integer, computes the Shimura lift G of weight 2k-1 corresponding to D. This function returns [mf2,G,v], where mf2 is a modular form space containing G, and v the vector of coefficients of G on mf."},
...
{"mscosets",0,(void*)mscosets0,15,"GG","mscosets(gen, inH): gen being a system of generators for a group G and H being a subgroup of finite index of G, return a list of right cosets of H \\ G and the right action of G on H \\ G. The subgroup H is given by a criterion inH (closure) deciding whether an element of G belongs to H."},
...
{"msfarey",0,(void*)msfarey0,15,"GGD&","msfarey(F,inH,{&CM}): F being a Farey symbol attached to a group G contained in SL2(Z) and H a subgroup of G, return a Farey symbol attached to H; H is given by a criterion inH (closure) deciding whether an element of G belongs to H."},
...
{"nfsubfieldscm",0,(void*)nfsubfieldscm,10,"GD0,L,","nfsubfieldscm(nf,{fl=0}): compute the maximal CM subfield of nf. Return 0 if nf does not have a CM subfield, otherwise return [g,h] (default) or g (fl=1) where g is an absolute equation and h expresses a root of g in terms of the generator of nf."},
{"nfsubfieldsmax",0,(void*)nfsubfieldsmax,10,"GD0,L,","nfsubfieldsmax(nf,{fl=0}): compute the list of maximal subfields of nf. Result is as in nfsubfields."},
...
{"plot",0,(void*)pariplot0,16,"vV=GGEDGDGp","plot(X=a,b,expr,{Ymin},{Ymax}): crude plot of expression expr, X goes from a to b, with Y ranging from Ymin to Ymax. If Ymin (resp. Ymax) is not given, the minimum (resp. the maximum) of the expression is used instead."},
...
{"plothraw",0,(void*)plothraw,16,"GGD0,L,","plothraw(X,Y,{flag=0}): plot in high resolution points whose x (resp. y) coordinates are in X (resp. Y). If flag is 1, join points, other nonzero flags should be combinations of bits 8,16,32,64,128,256 meaning the same as for ploth()."},
...
{"sqrtint",0,(void*)sqrtint0,5,"GD&","sqrtint(x,{&r}): integer square root y of x, where x is a nonnegative integer. If r is present, set it to the remainder x^2 - y."},
...
{"sqrtnint",0,(void*)sqrtnint,5,"GL","sqrtnint(x,n): integer n-th root of x, where x is nonnegative integer."},
...
{"suminf",0,(void*)suminf0_bitprec,9,"V=GEb","suminf(X=a,expr): naive summation (X goes from a to infinity) of real or complex expression expr."},
